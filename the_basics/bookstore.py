...
class Window(object):
    ...
    def __init__(self, window):
        ...
        self.list1.bind('<<ListboxSelect>>', self.getSelected_row)
    ...
    def update_command(self):
        database.update(self.selected_tuple[0], self.e1.get())
        self.view_command()

    def add_command(self):
        database.insert(self.title_text.get(), self.author_text.get(), self.year_text.get(), isbn_text.get())
        self.view_command()
    ...
    def getSelected_row(self, event):
        # try:
